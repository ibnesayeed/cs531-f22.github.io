...
Each student will implement an HTTP server with five assignments that demonstrate protocol conformance.
...
Grades will be determined solely on the design and performance of the HTTP servers.
